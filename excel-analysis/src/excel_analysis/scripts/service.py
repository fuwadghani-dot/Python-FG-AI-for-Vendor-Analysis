"""Packaged FastAPI service (copy of top-level service to be importable).

This module mirrors `scripts/service.py` so tests can import it as
`excel_analysis.scripts.service`.
"""
